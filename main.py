...
def draw_game_board() -> None:
    ...
    draw_text(constants.window, str(seconds_elapsed), 20, constants.COLOR_WHITE, (constants.BOARD_CENTER_X, 25))
...
def draw_selection_button():
    ...
    mines_selection_button = draw_button(constants.window, "xxxx", (761, 200), 40, constants.COLOR_RED, constants.COLOR_GREEN,(10, 10))
    height_selection_button = draw_button(constants.window, "xxxx", (561, 200), 40, constants.COLOR_RED, constants.COLOR_GREEN, (10, 10))
    width_selection_button = draw_button(constants.window, "xxxx", (361, 200), 40, constants.COLOR_RED, constants.COLOR_GREEN, (10, 10))
...
def reset() -> None:
    global have_mines_been_placed, mines, squares, flags, first_click, Title, GameSet, Opening, tick, frame_index, clock, hints
